...
function App() {
  ...
  return (
    <div className="min-h-screen bg-amber-50 text-gray-800 font-serif">
      <header className="bg-red-800 text-amber-50 py-6 text-center">
          ...
          {sections.map((section, index) => (
            <button
              ...
              className={`flex flex-col items-center p-4 rounded-lg transition-colors ${
                activeSection === index ? 'bg-red-800 text-amber-50' : 'bg-amber-100 hover:bg-amber-200'
              }`}
            >
      ...
      <footer className="bg-red-800 text-amber-50 py-4 text-center mt-8">
